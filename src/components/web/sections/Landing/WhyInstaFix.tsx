...
export default function WhyInstaFix() {
  return (
    <Section>
      <Container>
        <Flex direction="col-reverse" align="center" justify="between" gap="2xl" mdDirection="row">
          {/* Left Image */}
          ...
          <div className="mt-0 text-center sm:text-start">
            ...
            {whyInstaFixItems.map((why, index) => (
              <Flex key={index} align="start" gap="md" className="mb-8">
                <IconBox size="md" variant="rounded" bgColor="#EFF6FF">
                  <why.Icon size="md" className="text-[#2563EB]" />
                </IconBox>
                <Flex direction="col" gap="xs">
                  <h3 className="text-lg font-bold text-colors-primary">
                    {why.title}
                  </h3>

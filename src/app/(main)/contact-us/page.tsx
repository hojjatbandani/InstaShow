...
const CustomCart = ({ Icon, title, description, url, textLink }: CartProps) => {
  return (
    <Flex
      ...
      align="start"
      gap="md"
      className="w-full border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition p-6"
    >
...
export default function ContactPage() {
  return (
    <Section spacing="none" bgColor="#F7FAFC" className="pt-24 md:pt-36 pb-12 md:pb-16">
      <Container size="xl" fullHeight className="">
        <Flex
          direction="col"
          lgDirection="row"
          align="start"

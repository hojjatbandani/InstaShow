import {Button, Card, Container, Flex, Grid, IconBox, Section} from "@/components/ui";
	...
	return (
		<Section spacing="none" className="pt-24 md:pt-36 pb-12 md:pb-16">
          ...
          reliable, and verified professionals across the country.`}
				...
				<Grid cols={1} gap="none" className="my-4 md:my-10 lg:my-20 rounded-lg overflow-hidden">
					<Image
						src={aboutUsImage}
				...
				<Flex direction="col" mdDirection="row" align="start" justify="between" gap="xl" className="my-12 md:my-20">
            ...
            be Canada's fastest-growing home services marketplace.`}
					...
					<div className="relative w-full md:w-1/2 mt-8 md:mt-0">
						...
						/>
						<div className="hidden lg:block absolute left-0 bottom-0 w-[220px] p-6 rounded-lg bg-white shadow-lg
            text-sm font-light text-colors-primary transform translate-y-[30px] -translate-x-[20px]">
						...
						<div className="lg:hidden absolute left-0 bottom-0 mt-4 p-4 w-[200px] transform translate-x-1/2 translate-y-1/2 rounded-lg bg-white shadow-lg
            text-sm font-light text-colors-primary">
				...
				<div className="text-center my-20 md:my-28">
					...
					<Grid cols={3} gap="lg" className="mt-8 md:mt-10 text-start">
						{values.map((value, index) => (
							<Card key={index} className="h-full border border-gray-200 rounded-lg">
				...
				<div
					className="py-12 md:py-20 px-6 sm:px-10 md:px-20 bg-gradient-to-r from-[#3B82F6] to-[#2563EB] rounded-xl text-center">
